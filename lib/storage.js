...
const BASELINE_SEMANTICS_VERSION = 1;
...
function ensureBaselineSemantics(progress) {
  if (progress.baselineSemanticsVersion === BASELINE_SEMANTICS_VERSION) {
    return false;
  }

  progress.baselineSemanticsVersion = BASELINE_SEMANTICS_VERSION;
  progress.indexingComplete = false;
  progress.lastOffset = 0;
  for (const project of Object.values(progress.projects || {})) {
    project.indexingComplete = false;
    project.lastCursor = null;
  }
